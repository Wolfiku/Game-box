...
const T = {
  ...
  // Splitters / mergers (smart belts)
  SPLIT_R: 5, SPLIT_L: 6, SPLIT_U: 7, SPLIT_D: 8,  // output splits left+right of direction
  MERGE_R: 9,  // accepts from left or right, outputs in one direction (same for L/U/D use rotation)
  MINER:        10,
  SMELTER:      11,
  WIRE_MILL:    12,
  FORGE:        13,
  ...
  COLLECTOR:    22,
  COLL_BODY:    23,   // the other 8 tiles of a placed collector
...
const BELT_MERGE    = new Set([T.MERGE_R]); // single entry, engine handles rotation via meta
...
const ITEM_COLOR = {
  ...
  iron_plate:'#ccd', copper_wire:'#e09050', steel:'#8899aa',
...
const BUILDINGS = [
  ...
  {id:'miner', tileType:T.MINER, icon:'miner', name:'Miner', category:'mining',
   placeCost:null, craftTime:3.0},  // 3s per item (slow)
  // Collector (3x3)
  ...
  // Processing
  {id:'smelter',       tileType:T.SMELTER,       icon:'smelter',       name:'Smelter',       category:'processing', placeCost:{iron_ore:50},   input:{iron_ore:1},                  output:{iron_plate:1},   craftTime:2, energyCost:2},
  {id:'wire_mill',     tileType:T.WIRE_MILL,     icon:'wire_mill',     name:'Wire Mill',     category:'processing', placeCost:{copper_ore:50}, input:{copper_ore:1},                output:{copper_wire:2},  craftTime:2, energyCost:1},
...
// collector body tiles point back to collector def
...
const RESEARCH = [
  ...
  {id:'belt_speed_1',      name:'Fast Belts I',        category:'automation',cost_rp:400, description:'Belts 2x faster',         requires:null,                 effect:{beltSpeed:2}},
  {id:'belt_speed_2',      name:'Fast Belts II',       category:'automation',cost_rp:2000,description:'Belts 4x faster',         requires:'belt_speed_1',       effect:{beltSpeed:4}},
  {id:'stack_inserter',    name:'Stack Inserter',      category:'automation',cost_rp:3000,description:'Unlocks Adv. Collector',  requires:null,                 effect:{batchMult:2}},
];
